...
@Service
public class SecurityPdfReportServiceImpl implements SecurityPdfReportService {
    ...
    public SecurityPdfReportServiceImpl(SmartContractRepository smartContractRepository,
