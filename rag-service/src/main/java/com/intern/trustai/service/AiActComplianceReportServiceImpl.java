...
@Service
public class AiActComplianceReportServiceImpl implements AiActComplianceReportService {

    private final BlockchainProofRepository proofRepository;

    public AiActComplianceReportServiceImpl(BlockchainProofRepository proofRepository) {
